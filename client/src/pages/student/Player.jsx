...
const Player = () => {
	...
	return (
		<section className='min-h-[90vh] p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
			{/* left col */}
			<div className='text-gray-800'>
				...
				<div className='flex items-center gap-2 py-3 mt-10'>
					<h2 className='text-xl font-medium'>Rate this course:</h2>
