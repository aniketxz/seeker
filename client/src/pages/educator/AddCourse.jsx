...
const AddCourse = () => {
	...
	return (
		<div className='overflow-scroll flex flex-col items-start justify-between p-4 md:p-8 md:pb-0 pb-0 pt-8'>
			<form
				onSubmit={handleSubmit}
				className='flex flex-col gap-3 max-w-md w-full text-gray-500'
			>
				...
				<div className='flex items-center justify-between flex-wrap'>
					<div className='flex flex-col gap-1'>
						...
						<input
							...
							type='number'
							placeholder='0'
							className='outline-none py-2 md:py-2.5 w-28 px-3 rounded border border-gray-500'
							required
						/>
					</div>
				...
				<div>
					...
					{showPopup && (
						<div className='fixed inset-0 z-10 flex items-center justify-center bg-gray-600/40'>
